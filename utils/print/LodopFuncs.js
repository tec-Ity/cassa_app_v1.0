import install_lodop32 from "./install_lodop32.exe";
import install_lodop64 from "./install_lodop64.exe";
import CLodop_Setup_for_Win32NT from "./CLodop_Setup_for_Win32NT.exe";
...
function getLodop(oOBJECT, oEMBED) {
  ...
  var strHtm64_Install = `<br><font color='#FF00FF'>打印控件未安装!点击这里<a href=${install_lodop64} target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>`;
  var strHtm64_Update = `<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href=${install_lodop64} target='_self'>执行升级</a>,升级后请重新进入。</font>`;
  var strHtmFireFox =
  ...
  var strCLodopInstall_1 = `<br><font color='#FF00FF'>Web打印服务CLodop未安装启动，点击这里<a href=${CLodop_Setup_for_Win32NT} target='_self'>下载执行安装</a>`;
  ...
  var strCLodopUpdate = `<br><font color='#FF00FF'>Web打印服务CLodop需升级!点击这里<a href=${CLodop_Setup_for_Win32NT} target='_self'>执行升级</a>,升级后请刷新或重启浏览器。</font>`;
  var LODOP;
  try {
    var ua = navigator.userAgent;
    ...
    if (needCLodop()) {
      ...
      if (!LODOP) {
        ...
        if (window.CLODOP.CVERSION < "4.1.4.5") {
